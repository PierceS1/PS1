    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "Locations", url: "https://pspremierconstruction.com/#neighborhoods" },
          { name: "West Lake Hills", url: "https://pspremierconstruction.com/locations/west-lake-hills" },
        ]}
      />
        ...
        <main className="flex-1">
          ...
          <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-gray-950 to-black">
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <Breadcrumbs items={[{ label: "Locations", href: "/#neighborhoods" }, { label: "West Lake Hills" }]} />
            ...
            <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="prose prose-invert max-w-none">
                <p className="text-gray-300 text-lg leading-relaxed mb-4">
                  West Lake Hills represents the pinnacle of Austin luxury living, and your home deserves construction
                  and remodeling services that match this standard of excellence. PS Premier Construction has built a
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-4">
                  ...
                  builds to strict city codes and the importance of preserving those stunning hill country views.
                  Whether you're planning a complete{" "}
                  <Link
                    href="/services/custom-home-builder-austin"
                    className="text-brand-amber hover:text-brand-red underline"
                  >
                    custom home build
                  </Link>
                  , a{" "}
                  ...
                  that opens to your outdoor living space, or a primary suite addition that takes advantage of your
                  lot's natural beauty, our team brings the expertise and attention to detail that West Lake Hills
                  homeowners expect.
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card className="bg-gray-900 border-gray-800">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-xl font-bold mb-2 text-white">Custom Home Builds</h3>
                ...
                <Card className="bg-gray-900 border-gray-800">
                  <CardContent className="p-6">
                    <Home className="size-8 text-brand-amber mb-3" />
                    <h3 className="text-xl font-bold mb-2 text-white">Luxury Kitchen Remodels</h3>
                ...
                <Card className="bg-gray-900 border-gray-800">
                  <CardContent className="p-6">
                    <Home className="size-8 text-brand-amber mb-3" />
                    <h3 className="text-xl font-bold mb-2 text-white">Outdoor Living Spaces</h3>
                ...
                <Card className="bg-gray-900 border-gray-800">
                  <CardContent className="p-6">
                    <Home className="size-8 text-brand-amber mb-3" />
                    <h3 className="text-xl font-bold mb-2 text-white">Bathroom Remodels</h3>
          ...
          <section className="w-full py-12 bg-black">
            <div className="container mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
              ...
              <p className="text-gray-300 mb-6">
                Read real reviews from homeowners throughout West Lake Hills and the greater Austin area who have
                trusted us with their construction and remodeling projects.
              </p>
              <Link
                href="https://www.google.com/search?client=mobilesearchapp&sca_esv=8a5138757e73c890&bih=820&biw=402&channel=iss&cs=1&hl=en&rlz=1MDAPLA_enUS1013US1013&v=393.0.825685754&kgmid=/g/11x5kcfr2r&q=PS+Premier+Construction&shndl=30&shem=bdse,shrtsdl&source=sh/x/loc/hdr/m1/5&kgs=38ded009b8beeab0&utm_source=bdse,shrtsdl,sh/x/loc/hdr/m1/5"
                target="_blank"
          ...
          <section className="w-full py-12 bg-black border-t border-gray-800">
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <h2 className="text-2xl font-bold mb-6 text-center">We Also Serve Nearby Neighborhoods</h2>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-4xl mx-auto">
                {[
                  { name: "Tarrytown", href: "/locations/tarrytown" },
                  { name: "Barton Creek", href: "/locations/barton-creek" },
                  { name: "Rollingwood", href: "/locations/rollingwood" },
                  { name: "Davenport Ranch", href: "/locations/davenport-ranch" },
                  { name: "Cedar Park", href: "/locations/cedar-park" },
                ].map((location) => (
                  <Link
                    key={location.name}
                    href={location.href}
                    className="text-center p-4 bg-gray-900 hover:bg-gray-800 rounded-lg border border-gray-800 hover:border-brand-amber transition-colors"
                  >
                    <MapPin className="h-5 w-5 text-brand-amber mx-auto mb-2" />
