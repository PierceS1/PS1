    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "Services", url: "https://pspremierconstruction.com/#services" },
          { name: "Kitchen Remodeling", url: "https://pspremierconstruction.com/services/kitchen-remodeling-austin" },
        ]}
      />
        ...
        <main className="flex-1">
          ...
          <section className="w-full py-12 md:py-24 bg-gradient-to-b from-gray-900 to-black">
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <Breadcrumbs items={[{ label: "Services", href: "/#services" }, { label: "Kitchen Remodeling" }]} />
          ...
          <section className="w-full py-12 bg-black">
            <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
              <p className="text-lg text-gray-300 leading-relaxed">
                ...
                throughout Austin, from{" "}
                <Link href="/locations/west-lake-hills" className="text-brand-amber hover:text-brand-red underline">
                  West Lake Hills
                </Link>{" "}
                to{" "}
                <Link href="/locations/tarrytown" className="text-brand-amber hover:text-brand-red underline">
                  Tarrytown
                </Link>
                ,{" "}
                <Link href="/locations/barton-creek" className="text-brand-amber hover:text-brand-red underline">
                  Barton Creek
                </Link>{" "}
                to Central Austin. Whether you're dreaming of a chef's kitchen with professional-grade appliances, a
                family-friendly space with smart storage solutions, or a modern entertaining hub that flows seamlessly
                into your living areas, our team brings expertise, creativity, and precision to every kitchen remodeling
                project. We handle everything from initial design consultation through final installation, ensuring your
          ...
          <section className="w-full py-12 bg-gray-900">
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                <Card className="bg-gray-800 border-gray-700 hover:border-brand-amber transition-colors">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-bold text-white mb-2">
                      <Link href="/services/bathroom-remodeling-austin" className="hover:text-brand-amber">
                        Bathroom Remodeling
                      </Link>
                    </h3>
                    <p className="text-gray-400 text-sm mb-4">
                      Create spa-like bathrooms with luxury fixtures and custom tile work.
                    </p>
                    <Link
                      href="/services/bathroom-remodeling-austin"
                      className="text-brand-red hover:text-brand-amber text-sm inline-flex items-center gap-1"
                    >
                ...
                <Card className="bg-gray-800 border-gray-700 hover:border-brand-amber transition-colors">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-bold text-white mb-2">
                      <Link href="/services/home-additions-austin" className="hover:text-brand-amber">
                        Home Additions
                      </Link>
                    </h3>
                    <p className="text-gray-400 text-sm mb-4">
                      Expand your living space with seamless additions that blend perfectly.
                    </p>
                    <Link
                ...
                <Card className="bg-gray-800 border-gray-700 hover:border-brand-amber transition-colors">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-bold text-white mb-2">
                      <Link href="/services/custom-home-builder-austin" className="hover:text-brand-amber">
                        Custom Home Builds
                      </Link>
                    </h3>
                    <p className="text-gray-400 text-sm mb-4">
                      Build your dream home from the ground up with personalized design.
                    </p>
                    <Link
